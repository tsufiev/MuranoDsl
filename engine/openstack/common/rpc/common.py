...
from engine.openstack.common import importutils
from engine.openstack.common import jsonutils
from engine.openstack.common import local
from engine.openstack.common import log as logging
from engine.openstack.common import versionutils
...
The current message format (version 2.0) is very simple.  It is:
    ...
    {
        'engine.version': <RPC Envelope Version as a String>,
        'engine.message': <Application Message Payload, JSON encoded>
    }
...
_VERSION_KEY = 'engine.version'
_MESSAGE_KEY = 'engine.message'
